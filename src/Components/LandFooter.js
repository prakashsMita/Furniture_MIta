...
<a href="#">
<img class="img-fluid" src="./assets/img/Logo/Mita-logo.png" className="w-25"/>
</a>
{/* <a href="#">
...
<div class="col-md-2 col-6 col-sm-4 footermenu">
...
<div class="col-md-2 m-none col-4 col-sm-4 footermenu">
...
<footer class="pt-4 pb-4 text-center footcpybg">
<div class="container">
<p class="mt-0 mb-0">© Copyright 2024 Mita IT Automations. All Rights Reserved</p>
<small class="mt-0 mb-0"> Made with <i class="fas fa-heart heart-icon text-danger"></i> by 
<a class="text-danger" target="_blank" href="">Mita IT Automations</a> - <a class="text-primary" target="_blank" href=""></a>
</small>
</div>
</footer>
